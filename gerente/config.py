...
def get_data_dir() -> str:
    ...
    if getattr(sys, 'frozen', False):
        ...
        # __file__ está em gerente/config.py, o pai é o gerente/
        # e o pai do pai é a raiz do projeto.
        # Porém, para manter consistência com o launcher.py, 
        # vamos usar o ROOT do projeto.
...
def get_version_file_path() -> str:
    """Retorna o caminho para o arquivo version.json dentro do diretório de dados"""
    return os.path.join(get_data_dir(), 'version.json')


def get_updates_dir() -> str:
    """Retorna o caminho para o diretório de updates dentro do diretório de dados"""
    return os.path.join(get_data_dir(), 'updates')
