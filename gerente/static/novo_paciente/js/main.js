...
// Função para inicializar calculadora de Idade Gestacional
function initializeIdadeGestacionalCalculator() {
    const btnCalcular = document.getElementById('btnCalcularIdadeGestacional');
    ...
    if (btnCalcular) {
        btnCalcular.addEventListener('click', function(e) {
            ...
            if (dumInput && dumInput.value) {
                atualizarIdadeGestacional(dumInput.value);
            } else {
                alert('Por favor, preencha a Data da Última Menstruação (DUM) primeiro.');
            }
        });
    }
}
