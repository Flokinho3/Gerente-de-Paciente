...
from .itens_ignorados import bp as itens_ignorados_bp
from .paginas import bp as paginas_bp
from .pacientes import bp as pacientes_bp
from .sync import create_sync_blueprint, create_vps_blueprint
...
if getattr(sys, 'frozen', False):
    # PyInstaller extrai arquivos para sys._MEIPASS
    _base = sys._MEIPASS
else:
    # Modo desenvolvimento: assume que templates/static estão no nível acima de flask_app/
...
_app.register_blueprint(itens_ignorados_bp)
...
_app.register_blueprint(create_vps_blueprint())
from .event_logger import bp as event_logger_bp
_app.register_blueprint(event_logger_bp)
