...
from gerente.flask_app import app, run_flask, cleanup_flask

from gerente.inicio.utils.erro import exibir_erro
from gerente.inicio.opcoes import deve_exibir_console
from gerente.inicio.rede import verificar_e_liberar_porta, sincronizar_servidores
...
def iniciar_com_tray_icon(porta, config):
    ...
    try:
        from gerente.tray_icon import TrayIconManager
